...
const { username, comment, _id, deleteComment } = props
// const { deleteComment } = useContext(CommentContext)


    return (
        <div className="comment">
        <p id="comment-itself">"{ comment }"</p>
        <p id="by-comment">Posted by: @{ username }</p>
...
/*<button onClick={()=> deleteComment(_id)}  type="button" class="btn btn-outline-danger">
